main = {
    ...
    framework = { -- Incorrectly named but kept for backwards compatibility
        standalone = true, -- This is standalone
        ESX = false, -- This is for ESX Inventory
        QBCore = false, -- This is for QBCore Inventory
        alternativeQBCoreItemRemoval = {
            enabled = false,
            eventToTrigger = ""
        },
        vRP = false, -- This is for vRP Inventory
        oxInv = false, -- This is for OX Inventory
        ...
        jaksamInventory = false,
        cartridgeItemName = "taser_cartridge"
    },
    useUI = true, -- Use this to allow UI components to be enabled/disabled
    refreshTaserPresence = 700, -- In ms. This is how long between the server checking for presence of a taser in the players inventory.A lower number is more realistic but will have a greater detriment on perfromance
    ...
    nonLethalStungun = true, -- When true, stungun weapon damage is forced to zero and Smart Taser controls incapacitation.
    rangeToRemoveBarbs = 25.0, -- This is the range of barbs, after this, they will remove automatically
    -- When false, no rope/cable is created between taser and target. Barbs stay active in script (reactivate, remove barbs command, automatic rip at range) with the same behaviour as when ropes are on.
    enableTaserBarbRope = true,
